...
record('behavior', lambda: (_ for _ in ()).throw(AssertionError()) if run(4) != 18 else None)
record('order', lambda: (_ for _ in ()).throw(AssertionError()) if describe_pipeline() != ['cold', 'warm', 'serve'] else None)
