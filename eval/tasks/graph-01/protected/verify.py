...
record('behavior', lambda: (_ for _ in ()).throw(AssertionError()) if run(4) != 17 else None)
record('order', lambda: (_ for _ in ()).throw(AssertionError()) if describe_pipeline() != ['ingest', 'scale', 'offset'] else None)
