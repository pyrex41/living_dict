...
record('behavior', lambda: (_ for _ in ()).throw(AssertionError()) if run(4) != 23 else None)
record('order', lambda: (_ for _ in ()).throw(AssertionError()) if describe_pipeline() != ['alpha', 'beta', 'gamma'] else None)
