...
record('behavior', lambda: (_ for _ in ()).throw(AssertionError()) if run(4) != 12 else None)
record('order', lambda: (_ for _ in ()).throw(AssertionError()) if describe_pipeline() != ['parse', 'score', 'rank'] else None)
