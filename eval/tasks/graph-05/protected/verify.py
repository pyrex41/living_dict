...
record('behavior', lambda: (_ for _ in ()).throw(AssertionError()) if run(4) != 21 else None)
record('order', lambda: (_ for _ in ()).throw(AssertionError()) if describe_pipeline() != ['read', 'shape', 'emit'] else None)
