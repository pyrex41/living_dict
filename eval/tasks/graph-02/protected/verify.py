...
record('behavior', lambda: (_ for _ in ()).throw(AssertionError()) if run(4) != 10 else None)
record('order', lambda: (_ for _ in ()).throw(AssertionError()) if describe_pipeline() != ['decode', 'adjust', 'limit'] else None)
