...
record('behavior', lambda: (_ for _ in ()).throw(AssertionError()) if run(4) != 22 else None)
record('order', lambda: (_ for _ in ()).throw(AssertionError()) if describe_pipeline() != ['finalize', 'compute', 'prepare'] else None)
